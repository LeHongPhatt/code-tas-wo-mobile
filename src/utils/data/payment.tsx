...
export const paymentMethod = [
  {id: 1, title: 'Phát', icon: Images.driver},
  {id: 2, title: 'Lê', icon: Images.driver},
  {id: 3, title: 'Phát', icon: Images.driver},
  {id: 4, title: 'Lê', icon: Images.driver},
  {id: 5, title: 'Phát', icon: Images.driver},
  {id: 6, title: 'Lê', icon: Images.driver},
  {id: 7, title: 'Phát', icon: Images.driver},
  {id: 8, title: 'Lê', icon: Images.driver},
];
