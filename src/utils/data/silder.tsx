...
export const slidesIntro = [
  {
    ...
    title: 'Giao việc theo dõi tiến độ công việc thuận tiện',
    subtitle:
      'Giải pháp cho việc đánh giá khả năng hoàn thành công việc của từng phòng ban, nhân viên..',
  },
  {
    index: 2,
    image: Images.intro_02,
    title: 'Bảo mật thông tin nội bộ DN',
    subtitle:
      'Lưu trữ, bảo mật thông tin công việc nội bộ cho doanh nghiệp. Nhân viên nêu cáo tinh thần trách nhiệm đối với DN',
  },
  {
    index: 3,
    ...
    subtitle:
      'Tự động báo cáo khi hoàn thành công việc, kiểm tra và tối ưu việc quản lí nhân viên về tinh thần và thái độ trong công việc, báo cáo chính xác ...',
  },
];

export const surveyCompleteSlider = [
  {
    id: '1',
    title: 'Leman Luxury',
    img: Images.survey_complete,
  },
];
